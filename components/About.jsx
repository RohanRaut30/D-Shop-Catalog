...
const About = () => {
  return (
    <div className="container my-3">
      <h4 className="my-3 d-flex justify-content-center">|| D-shop Catalog ||</h4>
      <h4>Wellcome! 🙏</h4>
      <div className="my-2">
        ➤ Hi, I'm Rohan Raut, a FyMca student at Aims, Pune. I
      </div>
      <div className="my-4">
      ...
      <div className="my-3">
        ...
        {/* <div className="my-2">
          <ul>
            <li>Thanks to `Tabsbsum miss` for his guidance.</li>
          </ul>
        </div> */}
      </div>
